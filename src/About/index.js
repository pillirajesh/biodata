    ...
    <div className="about-container">
      <div className="about">
        ...
        <div className="description">
          <h4 style={{ color: "yellow" }}>About Me</h4>
          <p>
            ...
            collecting in projects. During my studies i was consistantly top of
            my academics. I have also completed my Full Stack Web Development
            Course. I am also a problem solver & I have the ability to quickly
            find efficient solution to any problem. I am good at communication &
            presentation skills that my core strength. I Completed my B.tech in
            Mechanical Engineering from Maulana Abul Kalam Azad University of
            Technology.
          </p>
        </div>
      </div>
